...
int main() {
    ...
    int textureLoaction1 = glGetUniformLocation(shaderProgram, "texture1");
    glUniform1i(textureLoaction1, 0); // 要在此之前激活程序
    int textureLoaction2 = glGetUniformLocation(shaderProgram, "texture2");
    glUniform1i(textureLoaction2, 1);
